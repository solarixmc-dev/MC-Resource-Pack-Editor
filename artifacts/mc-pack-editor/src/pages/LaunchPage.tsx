  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Decorative geometric shapes - visible on initial hero section */}
        {/* Large circles - top corners */}
        <div className="absolute top-12 left-12 w-56 h-56 border-2 border-[#C2B280]/20 rounded-full animate-spin-slow"></div>
        <div className="absolute top-16 right-16 w-72 h-72 border-2 border-[#C2B280]/15 rounded-full animate-spin-slow-reverse"></div>
        {/* Two squares - upper area */}
        <div className="absolute top-32 left-1/4 w-36 h-36 border-2 border-[#C2B280]/18 dark:border-[#C2B280]/25 rotate-45 animate-spin-slow"></div>
        <div className="absolute top-48 right-1/3 w-32 h-32 border-2 border-[#C2B280]/18 dark:border-[#C2B280]/25 rotate-60 animate-spin-slow-reverse"></div>
        {/* Pentagons - upper middle area */}
        ...
        <div className="absolute top-1/5 right-1/4 w-24 h-24 border-2 border-[#C2B280]/12 animate-spin-slow" style={{ clipPath: 'polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)' }}></div>
        {/* Small triangles - spread across viewport */}
        <div className="absolute top-36 left-1/2 w-0 h-0 border-l-[16px] border-r-[16px] border-b-[28px] border-l-transparent border-r-transparent border-b-[#C2B280]/12 animate-spin-slow"></div>
        <div className="absolute top-44 right-1/2 w-0 h-0 border-l-[12px] border-r-[12px] border-b-[20px] border-l-transparent border-r-transparent border-b-gray-300/25 dark:border-gray-600/25 animate-spin-slow-reverse"></div>
        <div className="absolute top-52 left-3/5 w-0 h-0 border-l-[14px] border-r-[14px] border-b-[24px] border-l-transparent border-r-transparent border-b-gray-300/30 dark:border-gray-600/30 animate-spin-slow"></div>
        ...
        {/* Additional squares and circles - lower viewport area */}
        <div className="absolute top-2/3 left-1/4 w-48 h-48 border-2 border-gray-300/40 dark:border-gray-600/40 rotate-45 animate-spin-slow"></div>
        <div className="absolute top-3/4 right-1/3 w-32 h-32 border-2 border-[#C2B280]/20 rotate-12 animate-spin-slow-reverse"></div>
        <div className="absolute top-3/5 right-1/4 w-40 h-40 border-2 border-[#C2B280]/15 rounded-full animate-spin-slow"></div>
        <div className="absolute top-4/5 left-1/6 w-28 h-28 border-2 border-gray-300/35 dark:border-gray-600/35 rotate-30 animate-spin-slow-reverse"></div>
        {/* Pentagons - lower viewport area */}
        <div className="absolute top-2/3 left-1/3 w-36 h-36 border-2 border-[#C2B280]/18 animate-spin-slow-reverse" style={{ clipPath: 'polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)' }}></div>
        <div className="absolute top-3/4 right-1/6 w-32 h-32 border-2 border-gray-300/30 dark:border-gray-600/30 animate-spin-slow" style={{ clipPath: 'polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)' }}></div>
        {/* Additional minimalist shapes */}
        <div className="absolute top-1/2 left-1/6 w-24 h-24 border-2 border-[#C2B280]/14 dark:border-[#C2B280]/20 rotate-90 animate-spin-slow"></div>
        <div className="absolute top-3/5 right-1/5 w-28 h-28 border-2 border-[#C2B280]/12 dark:border-[#C2B280]/18 rotate-45 animate-spin-slow-reverse"></div>
        <div className="absolute top-4/5 left-1/2 w-32 h-32 border-2 border-[#C2B280]/10 dark:border-[#C2B280]/15 rounded-full animate-spin-slow"></div>
        <div className="absolute top-1/4 right-1/2 w-0 h-0 border-l-[10px] border-r-[10px] border-b-[18px] border-l-transparent border-r-transparent border-b-[#C2B280]/8 dark:border-[#C2B280]/12 animate-spin-slow"></div>
        <div className="absolute top-3/4 left-1/5 w-0 h-0 border-l-[12px] border-r-[12px] border-b-[20px] border-l-transparent border-r-transparent border-b-[#C2B280]/10 dark:border-[#C2B280]/15 animate-spin-slow-reverse"></div>
      </div>
