  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Two squares near bottom of hero section */}
        <div className="absolute bottom-40 left-1/5 w-32 h-32 border-2 border-[#C2B280]/18 rotate-45 animate-spin-slow"></div>
        <div className="absolute bottom-32 right-1/4 w-36 h-36 border-2 border-gray-300/30 dark:border-gray-600/30 rotate-60 animate-spin-slow-reverse"></div>
