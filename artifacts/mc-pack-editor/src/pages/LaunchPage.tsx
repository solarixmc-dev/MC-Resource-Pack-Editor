  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-2/3 right-1/5 w-28 h-28 border-2 border-[#C2B280]/12 dark:border-[#C2B280]/18 rotate-45 animate-spin-slow-reverse"></div>
        <div className="absolute bottom-1/5 left-1/2 w-32 h-32 border-2 border-[#C2B280]/10 dark:border-[#C2B280]/15 rounded-full animate-spin-slow"></div>
        <div className="absolute top-1/5 right-1/2 w-0 h-0 border-l-[10px] border-r-[10px] border-b-[18px] border-l-transparent border-r-transparent border-b-[#C2B280]/8 dark:border-[#C2B280]/12 animate-spin-slow"></div>
        <div className="absolute bottom-2/5 left-1/5 w-0 h-0 border-l-[12px] border-r-[12px] border-b-[20px] border-l-transparent border-r-transparent border-b-[#C2B280]/10 dark:border-[#C2B280]/15 animate-spin-slow-reverse"></div>
      </div>
