  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Small triangles - spread around the page */}
        ...
        <div className="absolute top-48 right-1/4 w-0 h-0 border-l-[12px] border-r-[12px] border-b-[20px] border-l-transparent border-r-transparent border-b-gray-300/25 dark:border-gray-600/25 animate-spin-slow-reverse"></div>
        ...
        <div className="absolute top-2/5 right-1/3 w-0 h-0 border-l-[15px] border-r-[15px] border-b-[26px] border-l-transparent border-r-transparent border-b-[#C2B280]/10 animate-spin-slow-reverse"></div>
        <div className="absolute top-3/5 left-1/3 w-0 h-0 border-l-[13px] border-r-[13px] border-b-[22px] border-l-transparent border-r-transparent border-b-gray-300/25 dark:border-gray-600/25 animate-spin-slow"></div>
        <div className="absolute top-1/2 right-1/4 w-0 h-0 border-l-[14px] border-r-[14px] border-b-[24px] border-l-transparent border-r-transparent border-b-[#C2B280]/12 animate-spin-slow-reverse"></div>
        {/* Bottom area shapes */}
