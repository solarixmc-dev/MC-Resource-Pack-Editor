  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Two squares in top area - about 2.5 inches below top, spaced out */}
        <div className="absolute top-16 left-1/4 w-36 h-36 border-2 border-[#C2B280]/18 rotate-45 animate-spin-slow"></div>
        ...
        {/* Small triangles in top area - below circles, spread out */}
        <div className="absolute top-40 right-1/5 w-0 h-0 border-l-[16px] border-r-[16px] border-b-[28px] border-l-transparent border-r-transparent border-b-[#C2B280]/12 animate-spin-slow"></div>
        <div className="absolute top-48 left-1/6 w-0 h-0 border-l-[12px] border-r-[12px] border-b-[20px] border-l-transparent border-r-transparent border-b-gray-300/25 dark:border-gray-600/25 animate-spin-slow-reverse"></div>
        <div className="absolute top-56 left-1/4 w-0 h-0 border-l-[14px] border-r-[14px] border-b-[24px] border-l-transparent border-r-transparent border-b-gray-300/30 dark:border-gray-600/30 animate-spin-slow"></div>
        <div className="absolute top-44 left-1/3 w-0 h-0 border-l-[15px] border-r-[15px] border-b-[26px] border-l-transparent border-r-transparent border-b-[#C2B280]/10 animate-spin-slow-reverse"></div>
        <div className="absolute top-52 right-1/4 w-0 h-0 border-l-[13px] border-r-[13px] border-b-[22px] border-l-transparent border-r-transparent border-b-gray-300/25 dark:border-gray-600/25 animate-spin-slow"></div>
        <div className="absolute top-60 left-1/5 w-0 h-0 border-l-[14px] border-r-[14px] border-b-[24px] border-l-transparent border-r-transparent border-b-[#C2B280]/12 animate-spin-slow-reverse"></div>
        {/* Bottom area shapes */}
