    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-24">
        <div className="max-w-4xl w-full">
          ...
          {/* Features Grid */}
          {hasScrolled && (
            <div className={`grid md:grid-cols-3 gap-8 mb-16 transition-all duration-1000 ease-out delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="bg-gray-50 dark:bg-dark-secondary rounded-xl p-8 border-2 border-gray-200 dark:border-dark-border hover:border-[#C2B280] transition-colors">
              <div className="w-14 h-14 bg-black dark:bg-dark-text rounded-lg flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-white dark:text-dark-bg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-dark-text mb-3">Texture Editor</h3>
            ...
            <div className="bg-gray-50 dark:bg-dark-secondary rounded-xl p-8 border-2 border-gray-200 dark:border-dark-border hover:border-[#C2B280] transition-colors">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-dark-text mb-3">Pack Management</h3>
              <p className="text-gray-600 dark:text-dark-text-secondary text-base">
            ...
            <div className="bg-gray-50 dark:bg-dark-secondary rounded-xl p-8 border-2 border-gray-200 dark:border-dark-border hover:border-[#C2B280] transition-colors">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-dark-text mb-3">Local Library</h3>
              <p className="text-gray-600 dark:text-dark-text-secondary text-base">
