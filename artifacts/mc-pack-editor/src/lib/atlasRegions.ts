...
const ICONS_REGIONS: AtlasRegion[] = [
  ...
  { id: "boss_health_overlay", label: "Boss Health (Overlay)", x: 0, y: 86, w: 182, h: 5, description: "Boss health bar overlay" },
  // XP bar
  ...
  // Hotbar slots
  { id: "hotbar_slot", label: "Hotbar Slot", x: 0, y: 18, w: 22, h: 22, description: "Single hotbar slot" },
  { id: "hotbar_slot_selected", label: "Hotbar Slot (Selected)", x: 0, y: 40, w: 24, h: 24, description: "Selected hotbar slot" },
  // Creative inventory tabs
  { id: "creative_tab_search", label: "Creative Tab (Search)", x: 0, y: 91, w: 28, h: 28, description: "Creative search tab" },
  { id: "creative_tab_survival", label: "Creative Tab (Survival)", x: 28, y: 91, w: 28, h: 28, description: "Creative survival tab" },
  { id: "creative_tab_hotbar", label: "Creative Tab (Hotbar)", x: 56, y: 91, w: 28, h: 28, description: "Creative hotbar tab" },
  // Effect backgrounds
  { id: "effect_background", label: "Effect Background", x: 0, y: 119, w: 18, h: 18, description: "Status effect background" },
  // Status effect icons
  { id: "effect_speed", label: "Effect (Speed)", x: 0, y: 119, w: 18, h: 18, description: "Speed effect icon" },
  { id: "effect_slowness", label: "Effect (Slowness)", x: 18, y: 119, w: 18, h: 18, description: "Slowness effect icon" },
  { id: "effect_haste", label: "Effect (Haste)", x: 36, y: 119, w: 18, h: 18, description: "Haste effect icon" },
  { id: "effect_mining_fatigue", label: "Effect (Mining Fatigue)", x: 54, y: 119, w: 18, h: 18, description: "Mining fatigue effect icon" },
  { id: "effect_strength", label: "Effect (Strength)", x: 72, y: 119, w: 18, h: 18, description: "Strength effect icon" },
  { id: "effect_instant_health", label: "Effect (Instant Health)", x: 90, y: 119, w: 18, h: 18, description: "Instant health effect icon" },
  { id: "effect_instant_damage", label: "Effect (Instant Damage)", x: 108, y: 119, w: 18, h: 18, description: "Instant damage effect icon" },
  { id: "effect_jump_boost", label: "Effect (Jump Boost)", x: 126, y: 119, w: 18, h: 18, description: "Jump boost effect icon" },
  { id: "effect_nausea", label: "Effect (Nausea)", x: 144, y: 119, w: 18, h: 18, description: "Nausea effect icon" },
  { id: "effect_regeneration", label: "Effect (Regeneration)", x: 162, y: 119, w: 18, h: 18, description: "Regeneration effect icon" },
  { id: "effect_resistance", label: "Effect (Resistance)", x: 0, y: 137, w: 18, h: 18, description: "Resistance effect icon" },
  { id: "effect_fire_resistance", label: "Effect (Fire Resistance)", x: 18, y: 137, w: 18, h: 18, description: "Fire resistance effect icon" },
  { id: "effect_water_breathing", label: "Effect (Water Breathing)", x: 36, y: 137, w: 18, h: 18, description: "Water breathing effect icon" },
  { id: "effect_invisibility", label: "Effect (Invisibility)", x: 54, y: 137, w: 18, h: 18, description: "Invisibility effect icon" },
  { id: "effect_blindness", label: "Effect (Blindness)", x: 72, y: 137, w: 18, h: 18, description: "Blindness effect icon" },
  { id: "effect_night_vision", label: "Effect (Night Vision)", x: 90, y: 137, w: 18, h: 18, description: "Night vision effect icon" },
  { id: "effect_hunger", label: "Effect (Hunger)", x: 108, y: 137, w: 18, h: 18, description: "Hunger effect icon" },
  { id: "effect_weakness", label: "Effect (Weakness)", x: 126, y: 137, w: 18, h: 18, description: "Weakness effect icon" },
  { id: "effect_poison", label: "Effect (Poison)", x: 144, y: 137, w: 18, h: 18, description: "Poison effect icon" },
  { id: "effect_wither", label: "Effect (Wither)", x: 162, y: 137, w: 18, h: 18, description: "Wither effect icon" },
  { id: "effect_health_boost", label: "Effect (Health Boost)", x: 0, y: 155, w: 18, h: 18, description: "Health boost effect icon" },
  { id: "effect_absorption", label: "Effect (Absorption)", x: 18, y: 155, w: 18, h: 18, description: "Absorption effect icon" },
  { id: "effect_saturation", label: "Effect (Saturation)", x: 36, y: 155, w: 18, h: 18, description: "Saturation effect icon" },
  { id: "effect_glowing", label: "Effect (Glowing)", x: 54, y: 155, w: 18, h: 18, description: "Glowing effect icon" },
  { id: "effect_levitation", label: "Effect (Levitation)", x: 72, y: 155, w: 18, h: 18, description: "Levitation effect icon" },
  { id: "effect_luck", label: "Effect (Luck)", x: 90, y: 155, w: 18, h: 18, description: "Luck effect icon" },
  { id: "effect_unluck", label: "Effect (Unluck)", x: 108, y: 155, w: 18, h: 18, description: "Unluck effect icon" },
  { id: "effect_slow_falling", label: "Effect (Slow Falling)", x: 126, y: 155, w: 18, h: 18, description: "Slow falling effect icon" },
  { id: "effect_conduit_power", label: "Effect (Conduit Power)", x: 144, y: 155, w: 18, h: 18, description: "Conduit power effect icon" },
  { id: "effect_dolphins_grace", label: "Effect (Dolphins Grace)", x: 162, y: 155, w: 18, h: 18, description: "Dolphins grace effect icon" },
  { id: "effect_bad_omen", label: "Effect (Bad Omen)", x: 0, y: 173, w: 18, h: 18, description: "Bad omen effect icon" },
  { id: "effect_hero_of_the_village", label: "Effect (Hero of the Village)", x: 18, y: 173, w: 18, h: 18, description: "Hero of the village effect icon" },
];
