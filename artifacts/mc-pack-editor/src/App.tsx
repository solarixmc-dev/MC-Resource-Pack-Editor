            ...
            <div className="flex items-start gap-2 px-2 py-1 text-xs text-muted-foreground flex-shrink-0 sm:px-3">
              ...
              {totalOverrideCount > 0 && (
                <details className="group relative">
                  ...
                  <div className="absolute left-0 top-full z-[100] mt-2 max-h-[min(18rem,45vh)] w-[min(26rem,calc(100vw-2rem))] overflow-y-auto overscroll-contain rounded-xl border border-border bg-card/95 p-3 pb-4 shadow-2xl backdrop-blur">
